type Translation = {
  ...
  export const translations: Translations = {
    en: {
      ...
      attentionwindow: "Notice: This service is currently running on a temporary host. Please before starting work refresh the page and wait a few seconds while the server starts. I'm working on a permanent solution — thank you for your patience!",
    },
    es: {
      title: "Crawrix",
      ...
      attentionwindow: "Aviso: Este servicio se está ejecutando actualmente en un host temporal. Por favor antes de empezar a trabajar actualice la página y espere unos segundos mientras se inicia el servidor. Estoy buscando una solución permanente. ¡Gracias por su paciencia!",
    },
  };
